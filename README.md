...
[![Latest Stable Version](https://img.shields.io/packagist/v/rosgear/rg-theme-green.svg)](https://packagist.org/packages/rosgear/rg-theme-green)
...
### Установка
1. Загрузите папку `green` в директорию `/public/backend/themes/` вашего веб-приложения RosGear.
2. Активируйте тему с помощью компонента «Темы оформления» в Панели управления GePanel.

### Лицензия
Тема включает:
- [Bootstrap  v5.2.3](https://getbootstrap.com/) под лицензией [MIT](https://github.com/twbs/bootstrap/blob/main/LICENSE).
- [Font Awesome Pro 5.8.2](https://fontawesome.com/license).
- [WOW v1.1.3](https://github.com/mattdelacdev/WOW) под лицензией [GNU GPL license v3](https://github.com/all-licenses/GNU-General-Public-License-v3.0).
- Файлы шаблонов, изображения и стили темы под лицензией [GNU GPL license v3](https://github.com/all-licenses/GNU-General-Public-License-v3.0).
#### Шрифты
...
### Installation
1. Upload the `green` folder to the `/public/backend/themes/` directory of your RosGear web application.
2. Activate the theme using the Themes component in the GePanel Control Panel.

### License
The theme includes:
- [Bootstrap  v5.2.3](https://getbootstrap.com/) under license [MIT](https://github.com/twbs/bootstrap/blob/main/LICENSE).
- [Font Awesome Pro 5.8.2](https://fontawesome.com/license).
- [WOW v1.1.3](https://github.com/mattdelacdev/WOW) under license [GNU GPL license v3](https://github.com/all-licenses/GNU-General-Public-License-v3.0).
- Template files, images, and theme styles are licensed under [GNU GPL license v3](https://github.com/all-licenses/GNU-General-Public-License-v3.0).
#### Fonts
- Bauhaus Md BT, Copyright 1990-1993 Bitstream Inc.
